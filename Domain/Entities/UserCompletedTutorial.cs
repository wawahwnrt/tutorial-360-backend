...
namespace tutorial_backend_dotnet.Domain.Entities
{
    public class UserCompletedTutorial
    {
        ...
        [Column("step_id")] public int StepId { get; set; }

        [Column("step_group_id")] public int StepGroupId { get; set; }

        [Column("step_group_name")] public string StepGroupName { get; set; }

        [Column("complete_at")] public DateTime CompletedAt { get; set; }

        [Column("is_reset")] public bool IsReset { get; set; }

        // Navigation properties
        [ForeignKey("StepId")] public TutorialStep TutorialStep { get; set; }
